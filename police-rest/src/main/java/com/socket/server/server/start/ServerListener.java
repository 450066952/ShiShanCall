...
public class ServerListener implements ServletContextListener  {
	...
	private static final int PORT=81;//9209;//9207;//9005
    ...
    public void contextInitialized(ServletContextEvent arg0) {
		...
		bootstrap.setPipelineFactory(new ServerPipelineFactory(timer) {
			public ChannelPipeline getPipeline() throws Exception {
				...
				pipeline.addLast("timeout", new IdleStateHandler(timer, 25, 0, 0));//10 读  10 写 此两项为添加心跳机制 10秒查看一次在线的客户端channel是否空闲
