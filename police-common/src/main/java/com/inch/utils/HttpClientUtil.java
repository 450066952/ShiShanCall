...
public class HttpClientUtil {
	...
	public static String doPost(String url, Map<String, Object> param) {
		...
		try {
			...
			if (param != null) {
				...
				// 模拟表单
				UrlEncodedFormEntity entity = new UrlEncodedFormEntity(paramList,"utf-8");//by tony
	...
	public static void closeResponse(CloseableHttpClient httpClient,CloseableHttpResponse response){
		try {
			if (response != null) {
				response.close();
			}
