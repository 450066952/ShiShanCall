...
<div class="app-content-body fade-in-up ng-scope">
    ...
    <div ui-view="" class="ng-scope">
        ...
        <div class="bg-light lter b-b wrapper-md">
            <h1 class="m-n font-thin h3">人员统计</h1>
        </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-inline" id="searchForm">
                        ...
                        <span class="btn btn-sm btn-info" style="margin-left:20px" onclick="javascript:toSearch('${ctx}/personStatics/dataList.do')">查询</span>
                    </form>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        table = $('#inch_dataTable').DataTable({
            ...
            "dom": '<"toolbar">frtip',
            "ajax": {
                "url": "${ctx}/personStatics/dataList.do?starttime="+$("#starttime").val()+"&endtime="+$("#endtime").val(),
            ...
            "columnDefs": [ {
                ...
                render: function(a, b, c, d) {
                    ...
                    var html= "<a href=\"javascript:getDataDetial('"+c.userid +"','"+c.name+"')\" ><i class='icon-camera' title='详情'></i></a>";
                    return html;
                }
            }
            ]
    ...
    function getDataDetial(cguid,name){
        ...
        stuTable=$('#stuTable').DataTable({
            ...
            "dom": '<"toolbar">frtip',
            "ajax": {
                url: "${ctx}/personStatics/queryByPersonDetial.do?id="+cguid+"&starttime="+$("#starttime").val()+"&endtime="+$("#endtime").val()
            },
            "columns": [{
                "title":"姓名","data": "name"
            },{
