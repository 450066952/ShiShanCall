...
@Controller
@RequestMapping("/personStatics")
public class PersonStaticsAction extends BaseAction {
	...
	public ModelAndView  list(HttpServletRequest request,HttpServletResponse response) throws Exception{
		...
		return forword("webStatics/person",context);
	}
	
	@RequestMapping("/dataList")
	public void  dataList(HttpServletResponse response,HttpServletRequest request) throws Exception{
		BuidRequest.sendRequest(request,response,"webstatistics/queryByPerson","get");
	}
	...
	public void  queryByWindowDetial(HttpServletResponse response,HttpServletRequest request) throws Exception{
		BuidRequest.sendRequest(request,response,"webstatistics/queryByPersonDetial","get");
	}
